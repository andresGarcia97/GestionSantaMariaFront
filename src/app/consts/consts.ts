...
export const SALON_AMARILLO = 'SALON-AMARILLO';
export const SALON4 = 'SALON#4';
export const SALON3 = 'SALON#3';
export const ZONAS_VERDES = 'ZONAS VERDES';
export const CULTIVOS = 'CULTIVOS Y/0 JARDINERIA';
