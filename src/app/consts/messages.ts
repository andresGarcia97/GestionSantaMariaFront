...
export const ELIMINAR_HORARIO_EXITOSO = 'Se ha eliminado el horario satisfactoriamente';
export const ELEMINAR_HORARIO_ERRONEO = 'Error al eliminar el horario, Por favor intentalo nuevamente en unos minutos';
